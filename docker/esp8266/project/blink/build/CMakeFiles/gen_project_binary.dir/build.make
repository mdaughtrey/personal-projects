...
.bin_timestamp: blink.elf
	...
	/usr/bin/python /tools/ESP8266_RTOS_SDK/components/esptool_py/esptool/esptool.py --chip esp8266 elf2image --flash_mode dio --flash_freq 40m --flash_size 2MB --version=3 -o /build/build/blink.bin blink.elf
	/tools/cmake-3.5.2-Linux-x86_64/bin/cmake -E echo "Generated /build/build/blink.bin"
	/tools/cmake-3.5.2-Linux-x86_64/bin/cmake -E md5sum /build/build/blink.bin > /build/build/.bin_timestamp
