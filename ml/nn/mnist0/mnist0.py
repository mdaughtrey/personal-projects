...
X = np.fromfile(open('../mnist/train-images-idx3-ubyte', 'r'), dtype=np.uint8)[16:].reshape((-1, 28, 28))
Y = np.fromfile(open('../mnist/train-labels-idx1-ubyte', 'r'), dtype=np.uint8)[8:]
