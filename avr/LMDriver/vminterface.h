...
#define EEPROM_OFFSET_PROGRAM_CONTROL ROM_SIZE - 1
#define EEPROM_OFFSET_BINOFFSET_MSB ROM_SIZE - 3
#define EEPROM_OFFSET_BINOFFSET_LSB ROM_SIZE - 2
#define EEPROM_OFFSET_MAINOFFSET_MSB ROM_SIZE - 5
#define EEPROM_OFFSET_MAINOFFSET_LSB ROM_SIZE - 4
